  ...
  return (
    ...
    <main className=" flex flex-col space-y-8 bg-slate-900 px-3">
      ...
      <div className="flex justify-between items-center">
        ...
        <nav className="flex flex-col space-y-6 py-10 ml-3 bg-slate-800 bg-opacity-50 px-1 rounded-full  justify-center items-around align-around">
          <SocialIconsCol url="https://github.com/manmeet-ms/" name="GitHub" icon={<GitHub fontSize="small"  />} hoverColor="violet" />
          ...
          <SocialIconsCol url="https://www.linkedin.com/in/manmeets-/" name="LinkedIn" icon={<LinkedIn fontSize="small"  />} hoverColor="blue" />
          <SocialIconsCol url="mailto:manmeets.zsh@gmail.com" name="Contact" icon={<Mail fontSize="small"  />} hoverColor="violet" />
        </nav>

      </div>
      {/* actual footer below */}
      <footer className="text-slate-500 body-font bg-slate-800 bg-opacity-50 rounded-tl-2xl rounded-tr-2xl">
        {/* <span className="inline-flex lg:ml-auto lg:mt-0 mt-6 w-full justify-center md:justify-start md:w-auto">
          <a className="text-slate-600">
            <SocialIcons name="Instagram" icon={<Instagram />} /></a>
          <a className="ml-3 text-slate-600">
        ...
        <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
          ...
          <span className=" sm:mt-0 mt-2 w-full sm:text-center text-center text-slate-500 text-sm">Designed and developed by Manmeet Singh. Inspired by Linktree</span>
        </div>
      </footer>
    </main>
  );
